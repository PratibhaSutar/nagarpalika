  ...
  onClickSubmit(data:any){
    ...
    bind(){
      this.formdata = new FormGroup({
        ...
        name: new FormControl(this.employeedetail != null ? this.employeedetail.name : "", Validators.required),
        ...
        bank_acno: new FormControl(this.employeedetail != null ? this.employeedetail.bank_acno : "", [Validators.required, Validators.maxLength(15), Validators.required]),
        ifsc_code: new FormControl(this.employeedetail != null ? this.employeedetail.ifsc_code : "", Validators.required),
        uan_no: new FormControl(this.employeedetail != null ? this.employeedetail.uan_no : "", Validators.required),
        esic_icno: new FormControl(this.employeedetail != null ? this.employeedetail.esic_icno : "", Validators.required),
